...
\def\codecaptiontop {false}         % Leyenda arriba del código fuente
...
\def\tablecaptiontop {false}        % Leyenda arriba de las tablas
...
\def\stylecitereferences {apacite}  % Estilo refs. {apacite,bibtex,natbib,custom}
...
% NOMBRE DE OBJETOS
\def\nameabstract {Resumen ejecutivo}           % Nombre del resumen-abstract
